...
from convs.cifar_resnet_fre import resnet32_fre
from convs.resnet import resnet18, resnet34, resnet50, resnet101, resnet152
from convs.resnet_fre import resnet18_fre, resnet34_fre, resnet50_fre, resnet101_fre, resnet152_fre
from convs.ucir_cifar_resnet import resnet32 as cosine_resnet32
from convs.ucir_cifar_resnet_fre import resnet32_fre as cosine_resnet32_fre
from convs.ucir_resnet import resnet18 as cosine_resnet18
from convs.ucir_resnet import resnet34 as cosine_resnet34
from convs.ucir_resnet import resnet50 as cosine_resnet50
from convs.ucir_resnet_fre import resnet18_fre as cosine_resnet18_fre
...
from convs.resnet_cbam_fre import resnet18_cbam_fre, resnet34_cbam_fre, resnet50_cbam_fre
...
def get_convnet(args, pretrained=False):
    ...
    if name == "resnet32":
        return resnet32()
    elif name == "resnet32_fre":
        return resnet32_fre()
    elif name == "resnet18":
        return resnet18(pretrained=pretrained, args=args)
    elif name == "resnet18_fre":
        return resnet18_fre(pretrained=pretrained, args=args)
    elif name == "resnet34":
        return resnet34(pretrained=pretrained, args=args)
    elif name == "resnet34_fre":
        return resnet34_fre(pretrained=pretrained, args=args)
    elif name == "resnet50":
        return resnet50(pretrained=pretrained, args=args)
    elif name == "resnet50_fre":
        return resnet50_fre(pretrained=pretrained, args=args)
    elif name == "cosine_resnet18":
        return cosine_resnet18(pretrained=pretrained, args=args)
    elif name == "cosine_resnet18_fre":
        return cosine_resnet18_fre(pretrained=pretrained, args=args)
    elif name == "cosine_resnet32":
        return cosine_resnet32()
    elif name == "cosine_resnet32_fre":
        return cosine_resnet32_fre()
    ...
    elif name == "resnet18_cbam_fre":
        return resnet18_cbam_fre(pretrained=pretrained, args=args)
...
class IncrementalNet(BaseNet):
    def _init__(self, args, pretrained, gradcam=False):
...
class FOSTERNet(nn.Module):
    ...
    def forward(self, x, phase='test'):
        if phase == 'train':
            outputs = [convnet(x, phase) for convnet in self.convnets]
            features = [output_["features"] for output_ in outputs]
            features = torch.cat(features, 1)
            out = self.fc(features)
            out.update({"reconstruct_L": outputs[-1]["reconstruct_L"],
                        "reconstruct_H": outputs[-1]["reconstruct_H"]})
        else:
            features = [convnet(x)["features"] for convnet in self.convnets]
            features = torch.cat(features, 1)
            out = self.fc(features)

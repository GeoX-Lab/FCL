...
from utils.data import iCIFAR10, iCIFAR100, iImageNet100, iImageNet1000, iDomainCLEF, tiny_imagenet
from tqdm import tqdm

class DataManager(object):
    def __init__(self, dataset_name, shuffle, seed, init_cls, increment, data_dir=None):
        self.dataset_name = dataset_name
        if dataset_name == 'tiny_imagenet':
            self._setup_data(dataset_name, shuffle, seed, data_dir)
        else:
    ...
    def _setup_data(self, dataset_name, shuffle, seed, data_dir=None):
        idata = _get_idata(dataset_name)
        if dataset_name == 'tiny_imagenet':
            idata.download_data(data_dir)
        else:
            idata.download_data()

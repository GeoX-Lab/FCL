        ...
        for _, epoch in enumerate(prog_bar):
            ...
            for i, (_, inputs, targets) in enumerate(train_loader):
                ...
                if fda == 'standard':
                    ...
                    inputs, _, targets_L, targets_H = amplitude_mix_single_batch(inputs, fake_targets,
                                                                                 num_classes=self._total_classes - self._known_classes)
                    outputs = self._network(inputs, phase='train')
                    loss_fre_aug = _fre_aug_loss(outputs["reconstruct_L"], outputs["reconstruct_H"], targets_L, targets_H)
                else:
                ...
                loss = loss_clf + loss_fe + loss_kd + gama*loss_fre_aug

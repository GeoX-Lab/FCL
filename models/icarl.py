...
from utils.FDA import amplitude_mix_single_batch
    ...
    def _init_train(self, train_loader, test_loader, optimizer, scheduler):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            for i, (_, inputs, targets) in enumerate(train_loader):
                ...
                if fda == 'standard':
                    inputs, _, targets_L, targets_H = amplitude_mix_single_batch(inputs, targets, num_classes=self._total_classes)
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            for i, (_, inputs, targets) in enumerate(train_loader):
                ...
                if fda == 'standard':
                    ...
                    inputs, targets_, targets_L, targets_H = amplitude_mix_single_batch(inputs, targets, num_classes=self._total_classes, label_smoothing=True)
                ...
                loss = loss_clf + loss_kd + gama*loss_fre_aug

        ...
        for epoch in range(1, epochs + 1):
            ...
            for i, (_, inputs, targets) in enumerate(train_loader):
                ...
                if fda == 'standard':
                    ...
                    logits = out["logits"]
                    loss_aug_fre = gama * _fre_aug_loss(out["reconstruct_L"], out["reconstruct_H"], targets_L, targets_H)
                else:
                ...
                if stage == "training":
                    ...
                    if self._old_network is not None:
                        ...
                        loss = distill_loss * self.lamda + clf_loss * (1 - self.lamda) + loss_aug_fre
                    else:
                        loss = clf_loss + loss_aug_fre

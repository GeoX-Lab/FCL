...
class FeTrIL(BaseLearner):
    ...
    def _train(self, train_loader, test_loader):
        ...
        if self._cur_task == 0:
            ...
            train_loader = DataLoader(self._feature_trainset, batch_size=self.args["batch_size"], shuffle=True,
                                      num_workers=self.args["num_workers"], pin_memory=True)
            optimizer = optim.SGD(self._network_module_ptr.fc.parameters(), momentum=0.9, lr=self.args["lr"],
    ...
    def _train_function(self, train_loader, test_loader, optimizer, scheduler):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            for i, (_, inputs, targets) in enumerate(train_loader):
                ...
                loss = F.cross_entropy(logits, targets) + loss_fre_aug
